...
class CUHKPEDEDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        same_id_caption = self.caption[same_id_index]

        return image, label, caption, caption_code, caption_length, same_id_caption, same_id_caption_code, same_id_caption_length
    ...
    def get_data(self, index, img=True):
        ...
        return image, label, caption, caption_code, caption_length

    def caption_mask(self, caption): #caption here is caption code
...
class CUHKPEDE_txt_dateset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return label, caption, caption_code, caption_length
