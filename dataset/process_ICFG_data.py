...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/home/BigDataset/ReID/ICFG-PEDES/ICFG-PEDES.json', type=str)
...
def split_json(args):
    ...
    for data in reid_raw_data:
        data_save = {
            'img_path': '/home/BigDataset/ReID/ICFG-PEDES/imgs/'+data['file_path'],
            'id': data['id'],
