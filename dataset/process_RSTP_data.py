...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/home/BigDataset/ReID/RSTPReid/reid_raw.json', type=str)
    parser.add_argument('--out_root', default='./RSTPReid/processed_data', type=str)
...
def split_json(args):
    ...
    for data in reid_raw_data:
        data_save = {
            'img_path': '/home/BigDataset/ReID/RSTPReid/imgs/'+data['file_path'],
            'id': data['id'],
