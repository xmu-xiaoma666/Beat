...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/home/BigDataset/ReID/CUHK-PEDES/reid_raw.json', type=str)
...
def split_json(args):
    ...
    for data in reid_raw_data:
        data_save = {
            'img_path': '/home/BigDataset/ReID/CUHK-PEDES/imgs/'+data['file_path'],
            'id': data['id'],
...
def generate_captionid(data_json, word2Ind, data_name, args):
    ...
    print('%s_img_num: %d, %s_id_num: %d, %s_caption_num: %d, ' \
